      ...
      <div className="card" style={{ maxWidth: '500px', width: '100%', position: 'relative' }}>
        ...
        {step === 1 && (
          <div style={{ textAlign: 'center', animation: 'slideIn 0.3s ease-out' }}>
            <div style={{ display: 'inline-flex', padding: '1rem', background: 'rgba(157, 78, 221, 0.1)', borderRadius: '50%', color: 'var(--primary)', marginBottom: '1.5rem' }}>
              <Shield size={48} />
            </div>
        ...
        {step === 2 && (
          <div style={{ animation: 'slideIn 0.3s ease-out' }}>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', fontFamily: 'var(--font-display)', textAlign: 'center' }}>How AetherSplit Works</h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', marginBottom: '2rem' }}>
              ...
              <div style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
                <div style={{ background: 'rgba(157, 78, 221, 0.1)', color: 'var(--primary)', padding: '0.5rem', borderRadius: '8px' }}><Share2 size={20} /></div>
                <div>
