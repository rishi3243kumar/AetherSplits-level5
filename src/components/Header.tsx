      ...
      <div className="container header-inner">
        <div className="flex items-center gap-2">
          <div style={{
            ...
            height: '2rem',
            borderRadius: '0.5rem',
            background: 'linear-gradient(135deg, #9d4edd, #3f37c9)',
            display: 'flex',
            alignItems: 'center',
          ...
          <span className="logo" style={{ background: 'linear-gradient(135deg, #9d4edd 0%, #3f37c9 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', fontWeight: 800 }}>
            AetherSplit
          </span>
        </div>
