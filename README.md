...
- 📊 **Pitch Deck (PDF):** [docs/pitch_deck.pdf](https://github.com/rishi3243kumar/AetherSplits-level5/blob/master/docs/pitch_deck.pdf)
- 📊 **Verifiable On-Chain Proof (August Transactions):** [docs/real_user_proof.md](https://github.com/rishi3243kumar/AetherSplits-level5/blob/master/docs/real_user_proof.md) *(Copy and verify transaction hashes directly on the Stellar Testnet ledger)*
...
- 📊 **Pitch Deck (PDF):** [docs/pitch_deck.pdf](https://github.com/rishi3243kumar/AetherSplits-level5/blob/master/docs/pitch_deck.pdf)
- 📝 **Pitch Deck Content (Markdown):** [docs/pitch_deck_content.md](https://github.com/rishi3243kumar/AetherSplits-level5/blob/master/docs/pitch_deck_content.md)
...
👉 **[CLICK HERE TO VIEW THE FULL LIST OF VERIFIABLE TRANSACTIONS (LOCAL MD PROOF)](https://github.com/rishi3243kumar/AetherSplits-level5/blob/master/docs/real_user_proof.md)**
...
- **Google Form Response Sheet:** [Link](https://docs.google.com/spreadsheets/d/12IdB0ST-7fmTE2NQYBnYx242JAf4AlQA8Y9difnFtjA/edit?usp=sharing)
- **On-chain Data Export (Markdown):** [docs/real_user_proof.md](https://github.com/rishi3243kumar/AetherSplits-level5/blob/master/docs/real_user_proof.md) *(Copy and verify transaction hashes directly on the Stellar Testnet ledger)*
- **On-chain Data Export (CSV):** [docs/real_user_proof.csv](https://github.com/rishi3243kumar/AetherSplits-level5/blob/master/docs/real_user_proof.csv)
- **Total Unique Wallets:** 72
...
1. **Clone the repository:**
   ```bash
    git clone https://github.com/rishi3243kumar/AetherSplits-level5.git
    cd AetherSplits-level5
   ```
