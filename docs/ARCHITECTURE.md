...
## Frontend Fallback
AetherSplit maintains full backward compatibility with the legacy AetherSplits standard split functionality. Users can toggle between "Standard Split" (direct XLM payments) and "AetherSplit" (stealth mode) in the UI.
